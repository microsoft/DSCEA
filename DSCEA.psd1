...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('DesiredStateConfiguration', 'DSC', 'compliance', 'compliant', 'scan', 'scanning','test', 'testing', 'report', 'reporting', 'audit', 'auditing', 'config', 'configuration', 'security', 'baseline', 'baselines', 'lockdown', 'harden', 'hardening', 'Test-DscConfiguration')
