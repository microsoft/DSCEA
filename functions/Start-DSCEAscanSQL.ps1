...
param
    ...
    #Use csv convert function and keep results in memory
    ...
    $batchsize = 50000
    $table = "TableNameInSQL"

    # Use Username and Password that were passed in

        $connectionstring = 'Data Source={0};User Id={1};Password={2};Initial Catalog={3};' -f 'SQL.fqdn','Username','Password','Database'
    ...
    $DataTable = $parsedData | out-DataTable
